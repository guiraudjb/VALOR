...
export const PALETTE_GRADIENTS = {
  ...
  categorical:
    "linear-gradient(to right, #5C68E5, #82B5F2, #29598F, #31A7AE, #81EEF5, #B478F1, #CFB1F5, #CECECE)",
...
export const PALETTE_SCALES = {
  ...
  divergentDescending: window.d3.interpolateRgbBasis([
    "#298641",
    "#EFB900",
    "#E91719",
  ]),
  divergentAscending: window.d3.interpolateRgbBasis([
    "#E91719",
    "#EFB900",
    "#298641",
  ]),
  categorical: window.d3.interpolateRgbBasis([
    "#5C68E5",
    "#82B5F2",
    "#29598F",
    "#31A7AE",
